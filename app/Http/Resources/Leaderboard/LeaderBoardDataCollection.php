    ...
    ResourceCollection
{
    ...
    public function toArray($request)
    {
        ...
        $userTotalScore = Cache::remember('userTotalScore'.me()->id.$date, 300, function () use
        (
            $date
        ) {
        ...
        $userGuildScore = Cache::remember('userGuildScore'.me()->id.$date, 300, function () use
        (
            $date
        ) {
        ...
        $nationalData = Cache::remember('nationalData'.me()->id.$date.$page.$limit, 300, function () use
        (
            $date,
            $limit
        ) {
        ...
        $regionalData = Cache::remember('regionalData'.me()->id.$date.$page.$limit, 300, function () use
        (
            $date,
            $limit
        ) {
        ...
        $guildData = Cache::remember('guildData'.me()->id.$date, 300, function () use
        (
            $date
        ) {
        ...
        $ownPlaceRegional = Cache::remember('ownPlaceRegional'.me()->id, 300, function () use
        (
            $userTotalScore,
            $date
        ) {
        ...
        $ownPlaceNational = Cache::remember('ownPlaceNational'.me()->id, 300, function () use
        (
            $userTotalScore,
            $date
        ) {
        ...
        $ownPlaceGuild = Cache::remember('ownPlaceGuild'.me()->id, 300, function () use
        (
            $guildData,
            $userTotalScore
        ) {
